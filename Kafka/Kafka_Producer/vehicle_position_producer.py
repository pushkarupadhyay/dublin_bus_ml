# vehicle_positions_producer.py (PRODUCTION READY)
# Fetches Vehicle Positions from TFI GTFS Realtime API
...
# TFI API Configuration
TFI_VEHICLE_URL = "https://api.nationaltransport.ie/gtfsr/v2/Vehicles?format=json"
TFI_API_KEY = os.getenv("TFI_API_KEY", "a8d1f68c87cc441d9ba7fda4bb6989d3")
...
def fetch_vehicle_positions():
    """Fetch vehicle positions from TFI GTFS Realtime API"""
    try:
        headers = {
...
def parse_vehicle_position(entity):
    """Parse individual vehicle entity and extract key information"""
    try:
